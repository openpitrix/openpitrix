...
type OpenpitrixClusterListResponse struct {
	...
	// items
	Items OpenpitrixClusterListResponseItems `json:"items"`
...
func (m *OpenpitrixClusterListResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *OpenpitrixClusterListResponse) UnmarshalBinary(b []byte) error {
	var res OpenpitrixClusterListResponse
