...
func (o *ValidateUserPasswordReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewValidateUserPasswordOK()
...
func (o *ValidateUserPasswordOK) Error() string {
	return fmt.Sprintf("[POST /v1/users/password:validate][%d] validateUserPasswordOK  %+v", 200, o.Payload)
}

func (o *ValidateUserPasswordOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.OpenpitrixValidateUserPasswordResponse)
