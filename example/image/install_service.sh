...
mv opt/openpitrix/conf/openpitrix.service /lib/systemd/system/openpitrix.service
...
mv opt/openpitrix/sbin/exec.sh opt/openpitrix/sbin/start_default.sh opt/openpitrix/sbin/start_etcd.sh opt/openpitrix/sbin/start_openpitrix.sh /opt/openpitrix/sbin/
