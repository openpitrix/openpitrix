...
func (o *DescribeRepoTasksOK) Error() string {
	return fmt.Sprintf("[GET /v1/repo_tasks][%d] describeRepoTasksOK  %+v", 200, o.Payload)
}

func (o *DescribeRepoTasksOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.OpenpitrixDescribeRepoTasksResponse)
