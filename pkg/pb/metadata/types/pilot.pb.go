...
func (*PilotConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_pilot_36b693b53533c65d, []int{0}
}
...
func (*PilotTLSConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_pilot_36b693b53533c65d, []int{1}
}
...
func (*PilotClientTLSConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_pilot_36b693b53533c65d, []int{2}
}
...
func (*PilotEndpoint) Descriptor() ([]byte, []int) {
	return fileDescriptor_pilot_36b693b53533c65d, []int{3}
}
...
func init() { proto.RegisterFile("metadata/types/pilot.proto", fileDescriptor_pilot_36b693b53533c65d) }

var fileDescriptor_pilot_36b693b53533c65d = []byte{
