...
type DescribeCategoriesRequest struct {
	...
	SortKey              *wrappers.StringValue `protobuf:"bytes,7,opt,name=sort_key,json=sortKey" json:"sort_key,omitempty"`
	Reverse              *wrappers.BoolValue   `protobuf:"bytes,8,opt,name=reverse" json:"reverse,omitempty"`
	XXX_NoUnkeyedLiteral struct{}              `json:"-"`
	XXX_unrecognized     []byte                `json:"-"`
	XXX_sizecache        int32                 `json:"-"`
}
