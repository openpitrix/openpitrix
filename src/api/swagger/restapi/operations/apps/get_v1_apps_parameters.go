...
// GetV1AppsParams contains all the bound params for the get v1 apps operation
// typically these are obtained from a http.Request
//
// swagger:parameters GetV1Apps
...
func (o *GetV1AppsParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r
...
func (o *GetV1AppsParams) bindPageNumber(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetV1AppsParams) bindPageSize(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetV1AppsParams) validatePageSize(formats strfmt.Registry) error {
