...
func (o *ModifyClusterAttributesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewModifyClusterAttributesOK()
...
func NewModifyClusterAttributesOK() *ModifyClusterAttributesOK {
	return &ModifyClusterAttributesOK{}
}

/*ModifyClusterAttributesOK handles this case with default header values.

ModifyClusterAttributesOK modify cluster attributes o k
*/
...
func (o *ModifyClusterAttributesOK) Error() string {
	return fmt.Sprintf("[POST /v1/clusters/modify][%d] modifyClusterAttributesOK  %+v", 200, o.Payload)
}

func (o *ModifyClusterAttributesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.OpenpitrixModifyClusterAttributesResponse)
