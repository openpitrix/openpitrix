...
// OpenpitrixDescribeMarketsResponse openpitrix describe markets response
// swagger:model openpitrixDescribeMarketsResponse
...
func (m *OpenpitrixDescribeMarketsResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *OpenpitrixDescribeMarketsResponse) UnmarshalBinary(b []byte) error {
	var res OpenpitrixDescribeMarketsResponse
