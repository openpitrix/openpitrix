...
// OpenpitrixDeleteRuntimeEnvRequest openpitrix delete runtime env request
// swagger:model openpitrixDeleteRuntimeEnvRequest
...
func (m *OpenpitrixDeleteRuntimeEnvRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *OpenpitrixDeleteRuntimeEnvRequest) UnmarshalBinary(b []byte) error {
	var res OpenpitrixDeleteRuntimeEnvRequest
