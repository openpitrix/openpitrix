...
func (o *DescribeMarketUsersReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewDescribeMarketUsersOK()
...
func (o *DescribeMarketUsersOK) Error() string {
	return fmt.Sprintf("[GET /v1/market_users][%d] describeMarketUsersOK  %+v", 200, o.Payload)
}

func (o *DescribeMarketUsersOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.OpenpitrixDescribeMarketUsersResponse)
