...
func (o *ModifyRuntimeEnvCredentialReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewModifyRuntimeEnvCredentialOK()
...
func NewModifyRuntimeEnvCredentialOK() *ModifyRuntimeEnvCredentialOK {
	return &ModifyRuntimeEnvCredentialOK{}
}
...
func (o *ModifyRuntimeEnvCredentialOK) Error() string {
	return fmt.Sprintf("[PATCH /v1/runtime_env_credentials][%d] modifyRuntimeEnvCredentialOK  %+v", 200, o.Payload)
}

func (o *ModifyRuntimeEnvCredentialOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.OpenpitrixModifyRuntimeEnvCredentialResponse)
