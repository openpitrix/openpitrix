...
// OpenpitrixDeleteGroupsRequest openpitrix delete groups request
...
func (m *OpenpitrixDeleteGroupsRequest) validateGroupID(formats strfmt.Registry) error {
...
func (m *OpenpitrixDeleteGroupsRequest) UnmarshalBinary(b []byte) error {
	var res OpenpitrixDeleteGroupsRequest
