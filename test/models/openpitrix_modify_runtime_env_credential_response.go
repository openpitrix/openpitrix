...
// OpenpitrixModifyRuntimeEnvCredentialResponse openpitrix modify runtime env credential response
// swagger:model openpitrixModifyRuntimeEnvCredentialResponse
...
func (m *OpenpitrixModifyRuntimeEnvCredentialResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *OpenpitrixModifyRuntimeEnvCredentialResponse) validateRuntimeEnvCredential(formats strfmt.Registry) error {
...
func (m *OpenpitrixModifyRuntimeEnvCredentialResponse) UnmarshalBinary(b []byte) error {
	var res OpenpitrixModifyRuntimeEnvCredentialResponse
