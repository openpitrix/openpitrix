...
func (o *GetServiceConfigOK) Error() string {
	return fmt.Sprintf("[POST /v1/service_configs/get][%d] getServiceConfigOK  %+v", 200, o.Payload)
}

func (o *GetServiceConfigOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.OpenpitrixGetServiceConfigResponse)
