...
DescribeRuntimeCredentialsOK describe runtime credentials o k
*/
...
func (o *DescribeRuntimeCredentialsOK) Error() string {
	return fmt.Sprintf("[GET /v1/runtime_credentials][%d] describeRuntimeCredentialsOK  %+v", 200, o.Payload)
}
