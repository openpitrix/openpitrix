...
func (o *AttachKeyPairsOK) Error() string {
	return fmt.Sprintf("[POST /v1/clusters/key_pair/attach][%d] attachKeyPairsOK  %+v", 200, o.Payload)
}

func (o *AttachKeyPairsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.OpenpitrixAttachKeyPairsResponse)
