...
// WithUserIDValue adds the userIDValue to the get vendor verify info params
func (o *GetVendorVerifyInfoParams) WithUserIDValue(userIDValue string) *GetVendorVerifyInfoParams {
	o.SetUserIDValue(userIDValue)
	return o
}

// SetUserIDValue adds the userIdValue to the get vendor verify info params
func (o *GetVendorVerifyInfoParams) SetUserIDValue(userIDValue string) {
