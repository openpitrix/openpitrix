...
// NewGetV1ReposParams creates a new GetV1ReposParams object
// with the default values initialized.
func NewGetV1ReposParams() GetV1ReposParams {
	var (
		pageNumberDefault = int64(1)
		pageSizeDefault   = int32(20)
	)
	return GetV1ReposParams{
...
// GetV1ReposParams contains all the bound params for the get v1 repos operation
// typically these are obtained from a http.Request
//
// swagger:parameters GetV1Repos
type GetV1ReposParams struct {
...
func (o *GetV1ReposParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r
...
func (o *GetV1ReposParams) bindPageNumber(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetV1ReposParams) bindPageSize(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetV1ReposParams) validatePageSize(formats strfmt.Registry) error {
