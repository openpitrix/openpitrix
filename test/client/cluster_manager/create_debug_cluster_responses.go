...
func (o *CreateDebugClusterReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewCreateDebugClusterOK()
...
func (o *CreateDebugClusterOK) Error() string {
	return fmt.Sprintf("[POST /v1/debug_clusters/create][%d] createDebugClusterOK  %+v", 200, o.Payload)
}

func (o *CreateDebugClusterOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
