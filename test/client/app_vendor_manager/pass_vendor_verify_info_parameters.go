...
// WithUserIDValue adds the userIDValue to the pass vendor verify info params
func (o *PassVendorVerifyInfoParams) WithUserIDValue(userIDValue string) *PassVendorVerifyInfoParams {
	o.SetUserIDValue(userIDValue)
	return o
}

// SetUserIDValue adds the userIdValue to the pass vendor verify info params
func (o *PassVendorVerifyInfoParams) SetUserIDValue(userIDValue string) {
