...
func (m *AppRuntimes) validateItems(formats strfmt.Registry) error {
...
func (m *AppRuntimes) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *AppRuntimes) UnmarshalBinary(b []byte) error {
	var res AppRuntimes
