...
func (o *DescribeKeyPairsOK) Error() string {
	return fmt.Sprintf("[GET /v1/clusters/key_pairs][%d] describeKeyPairsOK  %+v", 200, o.Payload)
}

func (o *DescribeKeyPairsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.OpenpitrixDescribeKeyPairsResponse)
