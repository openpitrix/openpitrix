...
// NewGetV1ClustersParams creates a new GetV1ClustersParams object
// with the default values initialized.
func NewGetV1ClustersParams() GetV1ClustersParams {
	var (
		pageNumberDefault = int64(1)
		pageSizeDefault   = int32(20)
	)
	return GetV1ClustersParams{
...
// GetV1ClustersParams contains all the bound params for the get v1 clusters operation
// typically these are obtained from a http.Request
//
// swagger:parameters GetV1Clusters
...
func (o *GetV1ClustersParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r
...
func (o *GetV1ClustersParams) bindPageNumber(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetV1ClustersParams) bindPageSize(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetV1ClustersParams) validatePageSize(formats strfmt.Registry) error {
