...
// WithUserIDValue adds the userIDValue to the submit vendor verify info params
func (o *SubmitVendorVerifyInfoParams) WithUserIDValue(userIDValue string) *SubmitVendorVerifyInfoParams {
	o.SetUserIDValue(userIDValue)
	return o
}

// SetUserIDValue adds the userIdValue to the submit vendor verify info params
func (o *SubmitVendorVerifyInfoParams) SetUserIDValue(userIDValue string) {
