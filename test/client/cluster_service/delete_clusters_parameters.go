...
// WithIds adds the ids to the delete clusters params
func (o *DeleteClustersParams) WithIds(ids string) *DeleteClustersParams {
	o.SetIds(ids)
	return o
}

// SetIds adds the ids to the delete clusters params
func (o *DeleteClustersParams) SetIds(ids string) {
	o.Ids = ids
}
