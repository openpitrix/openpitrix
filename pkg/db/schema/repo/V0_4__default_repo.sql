...
values ('repo-vmbased', 'default vmbased repo', '', 's3://kubesphere-minio:9000/openpitrix-internal-repo/vmbased',
	...
	('repo-helm', 'default helm repo', '', 's3://kubesphere-minio:9000/openpitrix-internal-repo/helm',
		'{\"access_key_id\": \"openpitrixminioaccesskey\", \"secret_access_key\": \"openpitrixminiosecretkey\"}', 's3',
		'public', 'system', 'active', '2018-01-01 00:00:00', '2018-01-01 00:00:00');
