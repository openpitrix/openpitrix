...
COMPOSE_DB_CTRL=openpitrix-app-db-ctrl openpitrix-repo-db-ctrl openpitrix-runtime-db-ctrl openpitrix-job-db-ctrl openpitrix-task-db-ctrl openpitrix-cluster-db-ctrl openpitrix-iam-db-ctrl openpitrix-market-db-ctrl openpitrix-attachment-db-ctrl openpitrix-vendor-db-ctrl
CMD?=...
WITH_METADATA?=yes
WITH_K8S=no
comma:= ,
