...
// OpenpitrixRejectVendorVerifyInfoResponse openpitrix reject vendor verify info response
...
func (m *OpenpitrixRejectVendorVerifyInfoResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *OpenpitrixRejectVendorVerifyInfoResponse) UnmarshalBinary(b []byte) error {
	var res OpenpitrixRejectVendorVerifyInfoResponse
