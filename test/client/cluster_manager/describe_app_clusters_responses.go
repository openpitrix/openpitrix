...
func (o *DescribeAppClustersReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewDescribeAppClustersOK()
...
func (o *DescribeAppClustersOK) Error() string {
	return fmt.Sprintf("[GET /v1/clusters/apps][%d] describeAppClustersOK  %+v", 200, o.Payload)
}

func (o *DescribeAppClustersOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
