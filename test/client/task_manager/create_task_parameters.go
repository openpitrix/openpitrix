...
func (o *CreateTaskParams) WithBody(body *models.OpenpitrixCreateTaskRequest) *CreateTaskParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create task params
func (o *CreateTaskParams) SetBody(body *models.OpenpitrixCreateTaskRequest) {
	o.Body = body
}
