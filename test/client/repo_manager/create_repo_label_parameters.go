...
// NewCreateRepoLabelParams creates a new CreateRepoLabelParams object
// with the default values initialized.
func NewCreateRepoLabelParams() *CreateRepoLabelParams {
	var ()
	return &CreateRepoLabelParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewCreateRepoLabelParamsWithTimeout creates a new CreateRepoLabelParams object
...
// NewCreateRepoLabelParamsWithContext creates a new CreateRepoLabelParams object
...
// NewCreateRepoLabelParamsWithHTTPClient creates a new CreateRepoLabelParams object
...
/*CreateRepoLabelParams contains all the parameters to send to the API endpoint
for the create repo label operation typically these are written to a http.Request
*/
