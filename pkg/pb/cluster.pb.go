...
type Cluster struct {
	...
	ClusterNodeSet         []*ClusterNode         `protobuf:"bytes,22,rep,name=cluster_node_set,json=clusterNodeSet,proto3" json:"cluster_node_set,omitempty"`
	ClusterRoleSet         []*ClusterRole         `protobuf:"bytes,23,rep,name=cluster_role_set,json=clusterRoleSet,proto3" json:"cluster_role_set,omitempty"`
	ClusterLinkSet         []*ClusterLink         `protobuf:"bytes,24,rep,name=cluster_link_set,json=clusterLinkSet,proto3" json:"cluster_link_set,omitempty"`
	ClusterCommonSet       []*ClusterCommon       `protobuf:"bytes,25,rep,name=cluster_common_set,json=clusterCommonSet,proto3" json:"cluster_common_set,omitempty"`
	ClusterLoadbalancerSet []*ClusterLoadbalancer `protobuf:"bytes,26,rep,name=cluster_loadbalancer_set,json=clusterLoadbalancerSet,proto3" json:"cluster_loadbalancer_set,omitempty"`
	XXX_NoUnkeyedLiteral   struct{}               `json:"-"`
	XXX_unrecognized       []byte                 `json:"-"`
	XXX_sizecache          int32                  `json:"-"`
}
...
var fileDescriptor_3cfb3b8ec240c376 = []byte{
	...
	0xde, 0xee, 0xa2, 0x66, 0x69, 0xe4, 0x12, 0x07, 0xd8, 0xc0, 0xf1, 0x6e, 0x3e, 0x66, 0x13, 0x60,
	0x91, 0x43, 0x10, 0x04, 0xc8, 0x31, 0x40, 0x92, 0x4b, 0xb2, 0xa7, 0x9c, 0x82, 0x1c, 0x13, 0x20,
	...
	,
	...
	0xe6, 0x30, 0xbf, 0x07, 0xd7, 0xc6, 0x7e, 0xd0, 0x65, 0x58, 0xf7, 0xa7, 0x06, 0x98, 0x23, 0x66,
	...
	0x5a, 0xa4, 0xdb, 0x3d, 0xb2, 0xdb, 0xa7, 0x97, 0xa9, 0x47, 0x4d, 0xaf, 0xf8, 0xd2, 0x80, 0xf5,
	...
	,
}
