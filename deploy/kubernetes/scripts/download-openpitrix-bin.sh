...
# users do curl -L https://git.io/GetOpenPitrixBin | OPENPITRIX_VERSION=0.1.0 sh -
...
NAME="openpitrix-${OPENPITRIX_VERSION}-bin"
URL="https://github.com/openpitrix/openpitrix/releases/download/${OPENPITRIX_VERSION}/openpitrix-${OPENPITRIX_VERSION}-bin.tar.gz"
