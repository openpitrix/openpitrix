...
func init() {
	...
	proto.RegisterType((*AuthRequest)(nil), "openpitrix.AuthRequest")
	proto.RegisterType((*AuthResponse)(nil), "openpitrix.AuthResponse")
...
func (c *tokenManagerClient) Auth(ctx context.Context, in *AuthRequest, opts ...grpc.CallOption) (*AuthResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/openpitrix.TokenManager/Auth", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _TokenManager_Auth_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/openpitrix.TokenManager/Auth",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var fileDescriptor_0a2c201915207782 = []byte{
	...
	,
}
