...
type DroneServiceClient interface {
	...
	SetDroneConfig(ctx context.Context, in *openpitrix_types2.DroneConfig, opts ...grpc.CallOption) (*openpitrix_types.Empty, error)
...
func (c *droneServiceClient) SetDroneConfig(ctx context.Context, in *openpitrix_types2.DroneConfig, opts ...grpc.CallOption) (*openpitrix_types.Empty, error) {
...
type DroneServiceServer interface {
	...
	SetDroneConfig(context.Context, *openpitrix_types2.DroneConfig) (*openpitrix_types.Empty, error)
...
func _DroneService_SetDroneConfig_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(openpitrix_types2.DroneConfig)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DroneServiceServer).SetDroneConfig(ctx, req.(*openpitrix_types2.DroneConfig))
	}
	return interceptor(ctx, in, info, handler)
}
