...
type CreateRuntimeCredentialParams struct {
	...
	/*Body*/
	Body *models.OpenpitrixCreateRuntimeCredentialRequset
...
func (o *CreateRuntimeCredentialParams) WithBody(body *models.OpenpitrixCreateRuntimeCredentialRequset) *CreateRuntimeCredentialParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create runtime credential params
func (o *CreateRuntimeCredentialParams) SetBody(body *models.OpenpitrixCreateRuntimeCredentialRequset) {
	o.Body = body
}
