...
func (o *ModifyRepoLabelOK) Error() string {
	return fmt.Sprintf("[PATCH /v1/repos/labels][%d] modifyRepoLabelOK  %+v", 200, o.Payload)
}

func (o *ModifyRepoLabelOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.OpenpitrixModifyRepoLabelResponse)
