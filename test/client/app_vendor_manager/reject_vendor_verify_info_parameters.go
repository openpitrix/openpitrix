...
// WithUserIDValue adds the userIDValue to the reject vendor verify info params
func (o *RejectVendorVerifyInfoParams) WithUserIDValue(userIDValue string) *RejectVendorVerifyInfoParams {
	o.SetUserIDValue(userIDValue)
	return o
}

// SetUserIDValue adds the userIdValue to the reject vendor verify info params
func (o *RejectVendorVerifyInfoParams) SetUserIDValue(userIDValue string) {
	o.UserIDValue = userIDValue
}
...
func (o *RejectVendorVerifyInfoParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	// path param user_id.value
	if err := r.SetPathParam("user_id.value", o.UserIDValue); err != nil {
		return err
	}
