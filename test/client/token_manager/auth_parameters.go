...
type AuthParams struct {
	...
	/*Body*/
	Body *models.OpenpitrixAuthRequest
...
func (o *AuthParams) WithBody(body *models.OpenpitrixAuthRequest) *AuthParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the auth params
func (o *AuthParams) SetBody(body *models.OpenpitrixAuthRequest) {
	o.Body = body
}
